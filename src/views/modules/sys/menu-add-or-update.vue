...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      dataFormSubmit () {
		  var dates = {}
		  dates.menuId = this.dataForm.id|| undefined
		  dates.type = this.dataForm.type
		  dates.name = this.dataForm.name
		  dates.parentId = this.dataForm.parentId
		  dates.url = this.dataForm.url
		  dates.perms = this.dataForm.perms
		  dates.orderNum = this.dataForm.orderNum
		  dates.icon = this.dataForm.icon
		  
		  console.log('类型：',typeof dates,'dates:',dates)
