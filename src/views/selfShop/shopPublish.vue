  ...
  <div class="components-container main-cont">
    ...
    <el-dialog title="选择图片上传" :visible.sync="centerDialogVisible" width="30%" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-upload v-if="imgType==2 &&imgIndex==6" class="avatar-uploader" v-model="valueData[curRowIndex].skuImg"
          action="https://tbshopsadmin.hnqxkjfz.com/tao/alioss/uploads" :show-file-list="false"
    ...
    <el-dialog title="图片库" :visible.sync="centerDialogVisible1" width="800px" center>
      ...
      <el-checkbox-group v-model="imageUrlList">
        <el-checkbox v-for="(item,index) in typeDatasImg.content" :key="index" :label="item.imageUrl"
          ...
          <div
            style="text-align: center;margin-top: 10px;color: #666;overflow:hidden;white-space: nowrap;text-overflow: ellipsis;-o-text-overflow:ellipsis;width: 100px;">
            {{item.imageName}}</div>
        </el-checkbox>
      </el-checkbox-group>
      ...
      <div style="text-align: center;margin-top: 10px;">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[10, 20, 30]"
          ...
          :total="typeDatasImg.totalElements">
        </el-pagination>
      </div>
    </el-dialog>
    <el-dialog title="图片库" :visible.sync="centerDialogVisible2" width="800px" center>
      ...
      <div>
        <div v-for="(item,index) in typeDatasImg.content" :key="index"
          ...
          <div
            style="width: 100px;text-align: center;margin-top: 10px;color: #666;overflow:hidden;white-space: nowrap;text-overflow: ellipsis;-o-text-overflow:ellipsis;">
            {{item.imageName}}</div>
        </div>
      </div>
      <div style="text-align: center;margin-top: 10px;">
