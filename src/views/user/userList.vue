  ...
  <el-tabs v-model="activeName" @tab-click="handleClick">
    <el-tab-pane label="全部用户" name="first">
      <div style="margin:2% 0;display: inline-block;">
        <span>渠道筛选：</span>
        <el-select v-model="platform" placeholder="请选择类型" style="width:150px;" @change="selectTrigger(platform)">
        ...
        <el-input style="width: 150px;" @keydown.enter.native="select" clearable placeholder="请输入昵称" v-model="nickName">
        </el-input>
      </div>
      ...
      <el-table v-loading="tableDataLoading" :data="tableData.content">
        ...
        <el-table-column prop="grade" label="等级" width="150">
          <template slot-scope="scope">
            ...
            <div>
              <el-input type="text" @keydown.enter.native="addition(scope.row)" v-model="scope.row.grade" clearable
                placeholder="例0.3" style="width: 120px;font-size:14px;">
        ...
        <el-table-column prop="name" label="备注" width="150">
          <template slot-scope="scope">
            ...
            <div>
              <el-input type="text" @keydown.enter.native="remark(scope.row)" v-model="scope.row.name" clearable
                placeholder="备注" style="width: 120px;font-size:14px;">
        ...
        <el-table-column label="操作" fixed="right" width="120">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.relationId !==null && scope.row.pdd !==null" size="mini" type="primary"
              @click="price(scope.row)">多多比价
            </el-button>
            <el-button :disabled="!isAuth('userList:delete')" size="mini" type="danger" @click="deleteuser(scope.row)">
              删除用户
            </el-button>
          </template>
        </el-table-column>
    ...
    <el-tab-pane label="普通用户" name="third">
      ...
      <div style="display: inline-block;">
        <el-button style="margin-left:15px;" size="mini" type="primary" icon="document" @click="select">查询</el-button>
        <el-button style="margin-left:15px;" size="mini" type="primary" icon="document" @click="cleans4">重置</el-button>
    ...
    <el-tab-pane label="团长用户" name="fourth">
      ...
      <div style="display: inline-block;">
        <el-button style="margin-left:15px;" size="mini" type="primary" icon="document" @click="select">查询</el-button>
        <el-button style="margin-left:15px;" size="mini" type="primary" icon="document" @click="cleans5">重置</el-button>
    ...
    <el-tab-pane label="零钱用户" name="loose">
      ...
      <div style="display: inline-block;">
        <el-button style="margin-left:15px;" size="mini" type="primary" icon="document" @click="select3">查询</el-button>
        <el-button style="margin-left:15px;" size="mini" type="primary" icon="document" @click="cleans3">重置</el-button>
      </div>
