            ...
            button: [
              {
                type: 'view',
                name: '领券中心',
                url: 'https://tbshopsadmin.hnqxkjfz.com/?invitation=2242941210',
                sub_button: [],
              },
              {
                type: 'view',
                ...
                sub_button: [
                  {
                    type: 'view',
                    name: '个人中心',
                    url: 'https://tbshopsadmin.hnqxkjfz.com/pages/member/user',
                    sub_button: [],
                  },
                  {
                    type: 'view',
                    name: '新人攻略',
                    url: 'https://tbshopsadmin.hnqxkjfz.com/help/news.html',
                    sub_button: [],
                  },
                  {
                    type: 'view',
                    name: '联系客服',
                    url: 'https://tbshopsadmin.hnqxkjfz.com/custom.jpg',
                    sub_button: [],
                  },
                ]
              }
