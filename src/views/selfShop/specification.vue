<template>
  <div>
	  <div style = "float: right;margin-right:2%;">
	    <el-button style = "margin: 10px 0;" :disabled = "!isAuth('specification:add')" size = "mini" type = "primary" icon = "document"
	  ...
	  <el-table v-loading = "tableDataLoading" :data = "typeDatas.content" row-key = "id">
	   ...
	   <el-table-column prop = "ruleName" label = "规格名称">
	    ...
	    <el-table-column label = "操作" width = "180">
	      <template slot-scope = "scope">
	        <el-button size = "mini" type = "primary" :disabled = "!isAuth('specification:update')" @click = "updates(scope.row)">修改
	        </el-button>
	        <el-button size = "mini" type = "danger" :disabled = "!isAuth('specification:delete')" @click = "deletes(scope.row)">删除
	        </el-button>
	      </template>
	    </el-table-column>
	  </el-table>
