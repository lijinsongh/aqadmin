  ...
  <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-row>
          ...
          <el-col :span="6" class="cards" v-for="(item,index) in homeData.content" :key="index">
            ...
            <div class="bannerbtn">
              ...
              <a href="javascript:;" v-if="isAuth('localLife:delete')" @click="deleteslun(item.id)">删除</a>
            </div>
          </el-col>
        </el-row>
      </div>
      ...
      <el-dialog title="添加轮播图信息" :visible.sync="dialogFormVisible6" center>
        ...
        <div style="margin-bottom: 10px;display: flex;">
          ...
          <div
            ...
            <el-upload class="avatar-uploader" v-model="image_url" action="https://tbshopsadmin.hnqxkjfz.com/tao/alioss/upload"
    ...
    <el-dialog title="添加" :visible.sync="dialogFormVisible9" center>
      ...
      <div style="display: flex;"  v-if="nav==12">
        ...
        <div
          style=" width:148px;height:148px;border: 1px dashed #c0ccda;border-radius: 6px;text-align: center;line-height: 148px;">
          <el-upload class="avatar-uploader" v-model="backgroundImage" action="https://tbshopsadmin.hnqxkjfz.com/tao/alioss/upload"
