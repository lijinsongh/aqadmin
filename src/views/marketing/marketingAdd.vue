  ...
  <div class="components-container main-cont">
    <div style="position: relative;">
      ...
      <el-row>
        <el-col :span="24">
          <span>拼团会员价格：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团会员价格" v-model="memberPrice" autosize>
          </el-input>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="24">
          <span>拼团时效(小时)：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团时效" type="number" :min="1"
      ...
      <el-row style="margin-bottom: 15px;">
        <el-col :span="24">
          <span>拼团人数：</span>
          <el-input style="width: 150px;" class="margin15" placeholder="请输入拼团人数" type="number" :min="2" v-model="number"
            autosize></el-input>
        </el-col>
      </el-row>
        ...
        <div class="property_table">
          ...
          <el-table :data="valueData">
              ...
              <template slot-scope="scope">
                <div class="imgWrap"
                  ...
                  <el-upload style="width: 60px;height: 60px;" class="avatar-uploader" v-model="scope.row.skuImg"
                    ...
                    <img v-if="scope.row.skuImg" :src="scope.row.skuImg" @click="curRowIndex=scope.$index"
            ...
            <el-table-column width="100">
              <template slot-scope="scope">
                <div>
                  <el-input type="number" v-model="scope.row.pinkStock" :min="1" :max="scope.row.stock"
