              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="border-rt"><img
                      :src="tableData.image_url ? tableData.image_url : 'https://tbshopsadmin.hnqxkjfz.com/logo.png'" width="80"
                      height="80" /></td>
                </tr>
                <tr>
                  <th>微信名称</th>
      ...
      <el-tab-pane label="卡券明细" name="coupon">
        <el-table v-loading="tableDataLoading" :data="couponData">
          ...
          <el-table-column prop="createTime" label="创建时间">
			...
			<el-tab-pane label="邀请统计" name="yaoqingtongji">
				<div>
					<el-row v-loading="tableDataLoading1">
						...
						<el-col :span="6" class="cards">
							<div class="box">
								<div class="box_num">
									<div class="box_color">邀请人数</div>
									<div class="text_color"><span>{{taskStat.count ? taskStat.count : 0}}</span>单</div>
								</div>
							</div>
						</el-col>
					</el-row>
				...
				<el-table v-loading="tableDataLoading" :data="tableData2.content">
					...
					<el-table-column prop="imageUrl" label="用户头像">
						<template slot-scope="scope">
				...
				<div style="text-align: center;margin-top: 10px;">
					<el-pagination @size-change="handleSizeChangeTj" @current-change="handleCurrentChangeTj"
      ...
      rechargeSelect() {
        ...
        this.tableDataLoading = true
			...
			classifySelect() {
				...
				let userId = this.$route.query.userId
				this.$http({
					url: this.$http.adornUrl2('/userMoney/selectInviteCount'),
					method: 'get',
					params: this.$http.adornParams({
						'userId': userId
					})
			...
			taskdataSelect() {
				...
				let userId = this.$route.query.userId
				this.$http({
					url: this.$http.adornUrl2('/userMoney/selectSuperUserInvite'),
					method: 'get',
					params: this.$http.adornParams({
						'page': this.page - 1,
						'size': this.size,
