<template>
	<div>
		...
		<el-table v-loading="tableDataLoading" :data="tableData.content">
			...
			<el-table-column prop="commissionPrice" label="佣金">
				<template slot-scope="scope">
					<span style="color: #f56c6c;"
						v-if="scope.row.commissionPrice">{{scope.row.commissionPrice | numFilter}}</span>
					<span style="color: #f56c6c;" v-else>0.00</span>
				</template>
			</el-table-column>
			...
			<el-table-column prop="status" label="商品上下架" fixed="right" width="100">
				<template slot-scope="scope">
