		...
		<el-row>
					...
					<el-col :span="24">
						...
						<el-row class="order_item">
							<el-col :span="16">
								...
								<span v-if="tableData.status == 9">拼团中</span>
								<span v-if="tableData.status == 10">已评价</span>
							</el-col>
							<el-col :span="8">
								<span>支付方式:</span>
								<span style="color: #4f9dec;" v-if="tableData.payWay === 1 ">app微信</span>
								<span style="color: #4f9dec;" v-if="tableData.payWay === 2 ">微信公众号</span>
					...
					<el-col :span="24">
						...
						<el-row class="order_item border-top">
							...
							<el-col :span="8">
								...
								<div>规格：{{tableData.detailJson}}</div>
							</el-col>
							<el-col :span="6">
			...
			<el-col :span="8" style="float: right;">
				...
				<el-row class="item_right" v-if="tableData.isExpress == 1">
					<el-col :span="24">
						<h3>物流信息:</h3>
						<el-row class="order_item" v-if="tableData.status == 3 || tableData.status == 4 || tableData.status == 10">
							<el-col :span="12">
								<span>物流公司:</span>
						...
						<el-row class="order_item" v-else>
							暂无信息
						</el-row>
					</el-col>
				</el-row>
