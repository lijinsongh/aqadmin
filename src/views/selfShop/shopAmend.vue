		...
		<div v-loading="tableDataLoading">
			<div style="position: relative;">
				...
				<el-row>
					...
					<el-col :span="6">
						...
						<el-input style="width:200px;" class="margin15" placeholder="例0.1 等于10%" type="number" :min="0"
							:max="10" :controls="false" v-model="commissionPrice" autosize></el-input>
					</el-col>
					<el-col :span="6">
						<span>商品销量：</span>
				...
				<el-row>
					<!-- <el-col :span="6">
						<span>生产日期：</span>
						<el-date-picker class="margin15" style="width:200px;" v-model="productionDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" placeholder="选择生产日期">
						</el-date-picker>
					</el-col>
					<el-col :span="6">
						<span>到期时间：</span>
						<el-date-picker class="margin15" style="width:200px;" v-model="expirationDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" placeholder="选择到期时间">
						</el-date-picker>
					</el-col> -->
					<el-col :span="6">
						<span>必买理由：</span>
					...
					<el-col :span="6" style="margin-top: 20px;lin">
						<span>精选好物：</span>
          ...
          <div>
            <el-upload action="https://sanshengadmin.hnqxkjfz.com/tao/alioss/upload" class="avatar-uploader"
              ...
              <i class="el-icon-plus avatar-uploader-icon" style="font-size: 28px;color: #8c939d;width:148px;height:148px;background-color: #fbfdff;border: 1px dashed #c0ccda;border-radius: 6px;text-align: center;line-height: 148px;"></i>
				...
				<div style="display: flex;margin-top: 20px;" v-if="valueshow" v-loading="tableDataLoading1">
					<span>商品属性：</span>
			...
			<div class="tinymce-content" style="display: flex;position: relative;">
				...
				<quill-editor ref="myTextEditor" v-model="descrition" :options="quillOption"
					style="padding-bottom: 50px;height: 300px;width: 72%;display: inline-table;margin-bottom: 60px;margin-top:50px">
				</quill-editor>
			</div>
