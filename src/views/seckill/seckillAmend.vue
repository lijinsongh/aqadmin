  ...
  <div class="components-container main-cont">
    ...
    <div style="position: relative;">
      ...
      <el-row>
        <el-col :span="24">
          <span>秒杀会员价格：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入秒杀会员价格" v-model="memberPrice" autosize>
          </el-input>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="24">
          <span>秒杀开始时间：</span>
          <el-date-picker style="width:200px;" v-model="startTime" align="right" type="datetime" format="yyyy-MM-dd"
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="24">
          <span>秒杀结束时间：</span>
          <el-date-picker style="width:200px;" v-model="endTime" align="right" type="datetime" format="yyyy-MM-dd"
        ...
        <div class="property_table">
          ...
          <el-table :data="valueData">
            ...
            <el-table-column width="100">
              <template slot-scope="scope">
                <div>
                  <el-input type="number" v-model="scope.row.secKillStock" :min="1" :max="scope.row.stock"
