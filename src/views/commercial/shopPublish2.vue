    ...
    <div style="position: relative;">
      <div style="display: inline-block;font-size:18px;margin-bottom: 15px;">
        <a href="#" @click="prev" style="text-decoration:none;font-size: 14px;">
          <icon-svg name="jiantou" style="width: 1.2em;height: 1.2em;position: relative;top: 0.3em;">
          </icon-svg>
          返回
        </a>
      ...
      <el-row>
        ...
        <el-col :span="6">
          ...
          <el-select v-model="storeTypeId" class="margin15" placeholder="请选择店铺分类" style="width:200px;">
            <el-option v-for="(item,index) in storeTypeIds" :key="item.index" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-col>
        <!-- <el-col :span="6" >
      ...
      <el-row>
        <!-- <el-col :span="6">
					<span>生产日期：</span>
					<el-date-picker class="margin15" style="width:200px;" v-model="productionDate" type="date"
						format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择生产日期">
					</el-date-picker>
				</el-col>
				<el-col :span="6">
					<span>到期时间：</span>
					<el-date-picker class="margin15" style="width:200px;" v-model="expirationDate" type="date"
						format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择到期时间">
					</el-date-picker>
				</el-col> -->
        <el-col :span="6">
          <span>必买理由：</span>
        ...
        <div class="property_table">
          ...
          <el-table :data="valueData">
            ...
            <el-table-column prop="skuOriginalPrice" width="120">
              <template slot-scope="scope">
                <div>
                  <el-input type="text" v-model="scope.row.skuOriginalPrice" style="width:60px;font-size:14px;">
                  </el-input>
                </div>
              </template>
            </el-table-column>
            <el-table-column prop="skuPrice" width="120">
              <template slot-scope="scope">
                <div>
                  <el-input type="text" v-model="scope.row.skuPrice" style="width:60px;font-size:14px;">
                  </el-input>
                </div>
              </template>
            </el-table-column>
            <el-table-column prop="memberPrice" width="120">
              <template slot-scope="scope">
                <div>
                  <el-input type="text" v-model="scope.row.memberPrice" style="width:60px;font-size:14px;">
                  </el-input>
                </div>
              </template>
            </el-table-column>
